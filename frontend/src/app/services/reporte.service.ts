...
export class ReporteService {
  ...
  getReports(params?: any): Observable<{ success: boolean; data?: Reporte[]; erro?: string }> {
    return this.http.get<{ success: boolean; data?: Reporte[]; erro?: string }>('/api/reports', { params, withCredentials: true });
  }

  getRelatorios(params?: any): Observable<{ success: boolean; data?: Reporte[]; erro?: string }> {
    return this.http.get<{ success: boolean; data?: Reporte[]; erro?: string }>('/api/relatorios', { params, withCredentials: true });
  }
